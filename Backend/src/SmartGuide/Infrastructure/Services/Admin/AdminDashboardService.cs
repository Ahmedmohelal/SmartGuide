    ...
    public class AdminDashboardService: IAdminDashboardService  
    {
        ...
        public async Task<AdminRevenueDto> GetRevenueAsync()
        {
            ...
            var revenuePerGuide = await (
                ...
                into g
                select new GuideRevenueDto
                {
                    GuideId = g.Key.GuideId,
                    GuideName = g.Key.FirstName + " " + g.Key.LastName,
