...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20260506202926_AddPlaceRelationToTourStops")]
    partial class AddPlaceRelationToTourStops
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Book.BookingSlot", b =>
                {
                    ...
                    b.HasIndex("TourId", "Date", "StartTime")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entities.Book.BookingAddOn", b =>
                {
                    b.HasOne("Domain.Entities.Book.Booking", "Booking")
                        .WithMany("SelectedAddOns")
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Tours.TourAddOn", "TourAddOn")
                        .WithMany()
